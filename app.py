...
def training():
	if request.method =="POST":
		...
		for i in aspek:
			model, x_test, vectorizer, df_akurasi_plot, y_test, y_pred, gambar_cm, gambar_hm = bow.latih_model(raw_docs_train, i)
			list_df_akurasi.append(df_akurasi_plot)
			list_confusion_matrix.append(gambar_cm)
			list_heatmap.append(gambar_hm)    
			model_final[i] = model
		...
		# list_heatmap = bow.plot_heatmap(list_df_akurasi)
		heatmap_eval_makanan = list_heatmap[0]
		heatmap_eval_minuman = list_heatmap[1]
		heatmap_eval_pelayanan = list_heatmap[2]
		heatmap_eval_tempat = list_heatmap[3]
		heatmap_eval_harga = list_heatmap[4]
		...
		# print(type(text_case_folding))
		# print(type(text_stopword))
		# print(type(text_punct))
		# print(type(text_tokenisasi))
		# print(type(text_stemming))
		# print(type(text_c_slang))
		# print(type(heatmap_eval_makanan))
		# print(type(heatmap_eval_minuman))
		# print(type(heatmap_eval_pelayanan))
		# print(type(heatmap_eval_tempat))
		# print(type(heatmap_eval_harga))
		# print(type(cm_makanan))    
		# print(type(cm_minuman))  
		# print(type(cm_pelayanan))  
		# print(type(cm_tempat))  
		# print(type(cm_harga))  

		return jsonify({ 'text_input':text_input, 'text_case_folding':text_case_folding, 'text_stopword':text_stopword, 'text_punct':text_punct , 'text_tokenisasi':text_tokenisasi, 'text_stemming' : text_stemming, 'text_c_slang' : text_c_slang , 'heatmap_eval_makanan' : heatmap_eval_makanan, 'heatmap_eval_minuman' : heatmap_eval_minuman, 'heatmap_eval_pelayanan' : heatmap_eval_pelayanan, 'heatmap_eval_tempat' : heatmap_eval_tempat, 'heatmap_eval_harga' : heatmap_eval_harga, 'cm_makanan' : cm_makanan, 'cm_minuman' : cm_minuman, 'cm_pelayanan' : cm_pelayanan, 'cm_tempat' : cm_tempat, 'cm_harga' : cm_harga })  
