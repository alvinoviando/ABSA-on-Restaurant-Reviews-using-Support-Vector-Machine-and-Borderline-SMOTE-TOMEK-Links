...
$("#train-form").on("submit", function (e) {
  ...
  $.ajax({
    ...
    $('#heatmap_eval_makanan').empty()
    $('#heatmap_eval_minuman').empty()
    $('#heatmap_eval_pelayanan').empty()
    $('#heatmap_eval_tempat').empty()
    $('#heatmap_eval_harga').empty()
    $('#cm_makanan').empty()
    $('#cm_minuman').empty()
    $('#cm_pelayanan').empty()
    $('#cm_tempat').empty()
    ...
    $("#heatmap_eval_harga").append(
      "<center><img src=" +
        data.heatmap_eval_harga +
        " alt='Acc Chart' width='100%'></center>"
    );
    $("#heatmap_eval_makanan").append(
      "<center><img src=" +
        data.heatmap_eval_makanan +
        " alt='Acc Chart' width='100%'></center>"
    );
    $("#heatmap_eval_minuman").append(
      "<center><img src=" +
        data.heatmap_eval_minuman +
        " alt='Acc Chart' width='100%'></center>"
    );
    $("#heatmap_eval_pelayanan").append(
      "<center><img src=" +
        data.heatmap_eval_pelayanan +
        " alt='Acc Chart' width='100%'></center>"
    );
    $("#heatmap_eval_tempat").append(
      "<center><img src=" +
        data.heatmap_eval_tempat +
        " alt='Acc Chart' width='100%'></center>"
    );
    $("#cm_makanan").append(
      "<center><img src=" +
